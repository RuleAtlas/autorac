...
- For SNAP-style oracle-backed eligibility comparisons, do not introduce household proxy inputs like `snap_household_has_eligible_participating_member`; instead express the member-level participation facts directly and let the household consequence be computed from those person facts.
